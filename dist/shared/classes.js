...
function createNewClass(_a) {
    ...
    return { description: description, duration: duration, icon: icon, imageUrl: imageUrl, audience: audience, summary: summary, tags: tags, title: title };
}
