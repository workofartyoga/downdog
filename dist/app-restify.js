...
var init_api_1 = require("./api-restify/init-api");
var init_restify_static_files_1 = require("./init-restify-static-files");
dotenv.config();
...
init_restify_static_files_1.initStaticFiles(app);
// Audit Logging
